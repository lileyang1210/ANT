...
class PromptEmbedsCache: # for XL
...
class PromptEmbedsPair:
    ...
    def _erase(
        self,
        target_latents: torch.FloatTensor,  # "celebrity"
        positive_latents: torch.FloatTensor,  # "celebrity"
...
def load_prompts_from_yaml(path: str | Path, prompt: str) -> list[PromptSettings]:
    ...
    prompts[0]['positive'] = prompt
    prompts[0]['target'] = prompt
